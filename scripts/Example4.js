...
textExample.textContent = "Напишіть програму на JS, часто потрібно за даним номером року визначати до якої половини X якого століття C та якого тисячоліття M цей рік належить за Григоріанським календарем.";
